...
// impossible to stream something like a std::string directly to an unnamed
...
// Helper functions for std::string comparisons.
...
// Helper macro for std::string comparisons.
